                    ...
                    <Table.Tbody>
                        {competitions.map((competition, index) => {
                            return (
                                <Table.Tr key={index}>
                                    <Table.Th ta='center'>
                                        <Anchor component={Link} c='#f01d0c' href={competition.Tables_in_scoutschema.toString()}>{competition.Tables_in_scoutschema}</Anchor>
                                    </Table.Th>
                                    <Table.Th ta='center'>
                                        <Anchor component={Link} c='#f01d0c' href={`${process.env.NEXT_PUBLIC_BACKEND_URL}/download-data/${competition.Tables_in_scoutschema}`}>Download CSV Data</Anchor>
                                    </Table.Th>
                                </Table.Tr>
                            )
                        })}
